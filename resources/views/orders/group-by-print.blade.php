    ...
    <div class="page-break">
        <table class="table-mb">
            <tr>
                ...
                <td class="border-b w-35">
                    <span>{{$group_by_date ? \Carbon\Carbon::parse($index)->format('M-Y') : $chunk->first()->date->format('M-Y')}}</span>
                </td>
            </tr>
            <tr>
                <td class="border-0">
                ...
                <td colspan="3" class="border-b">
                    @if($group_by_location)
                        <span>{{ $chunks[$index]->location }}</span>
        ...
        <table>
            ...
            @foreach ($chunk as $key => $order)
                ...
                @php
                    ...
                    elseif($group_by_location) $columnSum += (float) $chunk->grand_total;
